...
import { LayoutDashboard, Columns, BarChart, TrendingUp, DollarSign } from 'lucide-react';
import { cn } from '@/lib/utils';
import { useConfig } from '@/hooks/use-config';
import ArAgingSummary from './ar-aging-summary';
import ActivityByMonth from './activity-by-month';
import DailyMonthlyCharges from './daily-monthly-charges';

const arReportTabs = [
    { value: "ar-aging-summary", label: "AR Aging Summary", icon: BarChart },
    { value: "activity-by-month", label: "Activity by Month", icon: TrendingUp },
    { value: "daily-monthly-charges", label: "Daily Monthly Charges", icon: DollarSign },
];

export default function ArReportsManager() {
    const [config] = useConfig();
    const [activeTab, setActiveTab] = useState("ar-aging-summary");
        ...
        <Card className="mt-4 border-none shadow-none">
            <Card className="mb-6 border-none shadow-md overflow-hidden bg-white/50 backdrop-blur-sm relative group">
                ...
                <div className="p-6 pt-8">
                    <h3 className="text-xl font-bold text-slate-800">AR Reports</h3>
            ...
            >
                ...
                <div className="flex-1 min-w-0">
                    <TabsContent value="ar-aging-summary" className="mt-0">
                        <ArAgingSummary />
                    </TabsContent>

                    <TabsContent value="activity-by-month" className="mt-0">
                        <ActivityByMonth />
                    </TabsContent>

                    <TabsContent value="daily-monthly-charges" className="mt-0">
                        <DailyMonthlyCharges />
                    </TabsContent>
                </div>
            </Tabs>
