...
import { LayoutDashboard, Columns, LogIn, ScrollText } from 'lucide-react';
import { cn } from '@/lib/utils';
import { useConfig } from '@/hooks/use-config';
import UserLogin from './user-login';
import AuditLogs from './audit-logs';

const systemReportTabs = [
    { value: "user-login", label: "User Login", icon: LogIn },
        ...
        <Card className="mt-4 border-none shadow-none">
            <Card className="mb-6 border-none shadow-md overflow-hidden bg-white/50 backdrop-blur-sm relative group">
                ...
                <div className="p-6 pt-8">
                    <h3 className="text-xl font-bold text-slate-800">System Reports</h3>
                    <p className="text-sm text-muted-foreground mt-1">
                        System activity and security reporting
                    </p>
                </div>
            </Card>
            ...
            >
                ...
                <div className="flex-1 min-w-0">
                    <TabsContent value="user-login" className="mt-0">
                        <UserLogin />
                    </TabsContent>
