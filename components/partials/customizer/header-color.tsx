      ...
      <div className=" grid grid-cols-3 gap-3 mb-4">
        <div>
          <button
            type="button"
            onClick={() => {
              setConfig({ ...config, headerColor: "light", sidebarColor: "light" });
              setShow(false);
            }}
        ...
        <div>
          <button
            ...
            onClick={() => {
              setShow(true);
              setConfig({ ...config, headerColor: "dark", sidebarColor: "dark" });
            }}
            disabled={show}
            className={cn(
              "border  block  border-default-300 rounded relative h-[72px] w-full disabled:cursor-not-allowed duration-150 overflow-hidden cursor-pointer",
        ...
        <div>
          <button
            type="button"
            onClick={() => {
              setConfig({ ...config, headerColor: "transparent", sidebarColor: "light" });
              setShow(false);
            }}
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button
                      type="button"
                      onClick={() =>
                        setConfig({ ...config, headerColor: color, sidebarColor: color })
                      }
